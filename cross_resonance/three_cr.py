...
#ctrl_pi_pulse = platform.create_RX_pulse(qubit=CTRL, start=max(tgt1_pi_pulse.finish,tgt2_pi_pulse.finish))
...
ps = PulseSequence(*[tgt1_cr_pulse, tgt2_cr_pulse, tgt1_ro_pulse, tgt2_ro_pulse, ctrl_ro_pulse])
