...
np.save(f'single_X_at_{time_X_pulse_start}_gnd_results.npy', np.asarray(crtl_gnd_results))
np.save(f'single_X_at_{time_X_pulse_start}_total_length.npy',np.asarray(total_length))